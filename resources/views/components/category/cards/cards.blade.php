    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative ">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300">
                    <a href="#" class="text-white text-lg font-bold uppercase">Explore Action Games</a>
                </div>
            </div>
            <div class="p-6 ">
                <h3 class="text-xl font-bold mb-2">Action</h3>
                <p class="text-gray-700">Discover adrenaline-pumping action games.</p>
                <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore Action Games</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300">
                    <a href="#" class="text-white text-lg font-bold uppercase">Explore Adventure Games</a>
                </div>
            </div>
            <div class="p-6">
                <h3 class="text-xl font-bold mb-2">Adventure</h3>
                <p class="text-gray-700">Embark on epic adventures in immersive worlds.</p>
                <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore Adventure Games</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center opacity-0 hover:opacity-100 transition duration-300">
                    <a href="#" class="text-white text-lg font-bold uppercase">Explore Arcade Games</a>
                </div>
            </div>
            <div class="p-6">
                <h3 class="text-xl font-bold mb-2">Arcade</h3>
                <p class="text-gray-700">Enjoy classic arcade-style gaming experiences.</p>
                <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore Arcade Games</a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore FPS Games</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore Fighting Games</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore RPG Games</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore Single-player Games</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="p-6 ">
                    ...
                    <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore Strategy Games</a>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden category-card">
            <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <a href="#" class="block mt-4 text-blue-500 hover:underline">Explore VR Games</a>
                </div>
            </div>
        </div>
    </div>
